...
recluse_shaders = [
  ...
  Shader('ShadowMapping', 'ShadowMapping.vert'),
  Shader('ShadowMapping', 'ShadowMapping.frag'),
  Shader('ShadowMapping_Opaque', 'ShadowMapping.frag', params='-DSHADOW_MAP_OPAQUE=1'),
  Shader('DynamicShadowMapping', 'DynamicShadowMapping.vert'),
  ...
  #Shader('ShadowMapping_OpaqueMorphTargets', 'ShadowMapping.vert', params='-DINCLUDE_MORPH_TARGET_ANIMATION=1 -DSHADOW_MAP_OPAQUE=1'),
